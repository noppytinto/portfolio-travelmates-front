    ...
    return (
        <div className={styles['timeline']}>
            <ul className={styles['timeline__content']}>
                <li><TimeEvent title="time event" starts={new Date(null, null, null, 5, 30)} color="blue" /></li>
                {/*<li><BaseEvent title="timeless event" color="green" /></li>*/}
                {/*<li><RangeEvent title="range event" color="orange" starts={new Date("06:00")} ends={new Date("08:30")}>*/}
